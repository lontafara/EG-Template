...
<div id="container"> 
  ...
  <!-- PAGINA DE INICIO -->
  <section  class="jumbotron jumbotron-lg jumbotron-fluid mb-0 pb-3 bg-lluvia position-relative">
...
<section class="jumbotron jumbotron-fluid mb-3 bg-lluvia position-relative">
