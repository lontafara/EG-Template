...
<div id="container"> 
  ...
  <!-- PAGINA DE INICIO -->
  <section  class="jumbotron jumbotron-lg jumbotron-fluid mb-0 pb-3 bg-cyan position-relative">
...
<section class="jumbotron jumbotron-fluid mb-3 bg-cyan position-relative fondok2">
  <div class="container text-white h-100 tofront">
    <div class="row align-items-center justify-content-center text-center">
      <div class="col-md-10">
        <h1 class="display-5"><?php if($idactual=='190'){echo'<span class="subtituloSEO1 text-white-50"><i class="fad fa-code mr-2"></i>Este Gráfico. <br/>Diseño y programación web Freelance.</span>';}; ?><?php echo $pagetitle;?> </h1>
  ...
  <?php
    ...
    { ?>
      ...
      <div class="row ml-3">
        ...
        <div class="col-md-4">
          <div class="sidebar">
            <jdoc:include type="modules" name="eg-left" style="leftright" />
          </div>
        </div>
        <?php } ?>
        <div class="col-md-9 ">
        ...
        <div class="col-md-3">
          <div class="sidebar">
            <jdoc:include type="modules" name="eg-right" style="leftright" />
          </div>
        </div>
        <?php } ?>
      </div>
