...
<div class="form-group">
    <label class="formComment" for="commentText">Comentario *</label>
	<textarea rows="6" cols="10" class="form-control" onblur="if(this.value=='') this.value='<?php echo JText::_('K2_ENTER_YOUR_MESSAGE_HERE'); ?>';" onfocus="if(this.value=='<?php echo JText::_('K2_ENTER_YOUR_MESSAGE_HERE'); ?>') this.value='';" name="commentText" id="commentText" >Su mensaje aquí</textarea>
</div>
	...
	<input type="submit" class="btn btn-primary btn-round" id="submitCommentButton" value="Enviar Comentario" />
