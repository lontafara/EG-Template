...
<section id="blog-section" class="userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	<div class="container">
	...
	<div class="jumbotron p-4 mt-4 jumbotron-fluid">
		...
		<div class="row justify-content-between align-items-top text-md-center text-lg-left">
		  <div class="col-lg-3">
		  <img src="<?php echo $this->user->avatar; ?>" alt="<?php echo htmlspecialchars($this->user->name, ENT_QUOTES, 'UTF-8'); ?>" class="rounded-circle shadow float-right" />
		  </div>
		  <div class="col-lg-9">
	    	<div class="itemAuthorDetails">
	      	<h5 class="itemAuthorName"><?php echo $this->user->name; ?></h5>
